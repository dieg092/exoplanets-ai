...
const Chat = () => {
  ...
  return (
    ...
    >
      <div className="opacity-100 transition-opacity duration-700 absolute flex flex-col top-1/2 md:left-[82%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 md:w-1/3 w-2/3 h-5/6 bg-neutral-900 bg-opacity-20 backdrop-blur-lg rounded-xl shadow-xl border border-white border-opacity-20">
